...
QWEN_17B_MODEL_ID = "Qwen/Qwen3-1.7B-Base"
QWEN_17B_DTYPE = "bfloat16"
...
HOT_KERNEL_CASES: dict[str, HotKernelCase] = {
    "q_proj_prefill64": HotKernelCase(
        ...
        description="Prefill bucket for the dense Q projection: [64, 2048] x [2048, 2048].",
        model_id=QWEN_17B_MODEL_ID,
        dtype=QWEN_17B_DTYPE,
        m=64,
        n=2048,
        k=2048,
        m_tile=64,
    ...
    "q_proj_prefill1024": HotKernelCase(
        ...
        kernel_kind="gemm",
        role="Q projection GEMM",
        description="Long-prefill bucket for the dense Q projection: [1024, 2048] x [2048, 2048].",
        model_id=QWEN_17B_MODEL_ID,
        dtype=QWEN_17B_DTYPE,
        m=1024,
        n=2048,
    ...
    "kv_proj_prefill64": HotKernelCase(
        ...
        description="Prefill bucket for K/V projections with grouped-query output width: [64, 2048] x [2048, 1024].",
        model_id=QWEN_17B_MODEL_ID,
        dtype=QWEN_17B_DTYPE,
        m=64,
        n=1024,
    ...
    "o_proj_prefill64": HotKernelCase(
        ...
        description="Prefill bucket for the dense output projection: [64, 2048] x [2048, 2048].",
        model_id=QWEN_17B_MODEL_ID,
        dtype=QWEN_17B_DTYPE,
        m=64,
        n=2048,
    ...
    "gate_up_proj_prefill64": HotKernelCase(
        ...
        description="Prefill bucket for the gated MLP expansion: [64, 2048] x [2048, 6144].",
        model_id=QWEN_17B_MODEL_ID,
        dtype=QWEN_17B_DTYPE,
        m=64,
        n=6144,
    ...
    "down_proj_prefill64": HotKernelCase(
        ...
        description="Prefill bucket for the MLP contraction: [64, 6144] x [6144, 2048].",
        model_id=QWEN_17B_MODEL_ID,
        dtype=QWEN_17B_DTYPE,
        m=64,
        n=2048,
    ...
    "rmsnorm_prefill64": HotKernelCase(
        ...
        kernel_kind="rmsnorm",
        role="RMSNorm",
        description="Prefill bucket for the transformer RMSNorm over hidden size 2048 with 64 rows.",
        model_id=QWEN_17B_MODEL_ID,
        dtype=QWEN_17B_DTYPE,
        m=64,
        hidden_size=2048,
    ...
    "rmsnorm_prefill1024": HotKernelCase(
        ...
        kernel_kind="rmsnorm",
        role="RMSNorm",
        description="Long-prefill RMSNorm bucket over hidden size 2048 with 1024 rows.",
        model_id=QWEN_17B_MODEL_ID,
        dtype=QWEN_17B_DTYPE,
        m=1024,
        hidden_size=2048,

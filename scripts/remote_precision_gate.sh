...
RESULT_DIR="${RESULT_DIR:-$REMOTE_HOME/artifacts/precision-gate}"
...
OUTPUT_PATH=\"$RESULT_DIR/precision_gate_\${STAMP}.json\"; \
EXTRA_ARGS=\"\"; \
if [[ \"$REQUIRE_SUCCESS\" == \"1\" ]]; then EXTRA_ARGS=\"--require-success\"; fi; \
python3 /home/pto/lean/repo/experiments/cutile/precision_gate.py --output \"\$OUTPUT_PATH\" \$EXTRA_ARGS > /dev/null; \

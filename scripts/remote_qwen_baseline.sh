...
PROMPT="${PROMPT:-Summarize why fixing Qwen3-4B-Base to GB10 can let an agent generate a higher-throughput inference path than a compatibility-heavy framework stack.}"
